...
namespace Joy\VoyagerBreadPipeline\Models;
...
use Joy\VoyagerBreadPipeline\Database\Factories\PipelineFactory;
...
class Pipeline extends Model
{
    ...
    {
        return $this->belongsTo(Voyager::modelClass('Pipeline'));
    }
